...
if start_button:
    ...
    st.session_state['experiment_no'] += 1 # Incrementa o número do experimento
    mean = toss_coin(number_of_trials)
    # Adiciona o resultado do experimento ao DataFrame no estado da sessão
...
# Exibe o DataFrame com os resultados de todos os experimentos
